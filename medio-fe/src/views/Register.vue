...
<template>
  <AuthShell
    :eyebrow="step === 'otp' ? 'Verifikasi Email' : 'Daftar Akun'"
    :title="step === 'otp' ? 'Masukkan kode OTP' : 'Buat akun Optik Medio'"
    :description="step === 'otp' ? 'Kode 6 digit dikirim ke email yang terdaftar.' : 'Gunakan data aktif agar pesanan dan layanan purna jual mudah diproses.'"
    panel-title="Mulai belanja kacamata dengan data tersimpan."
    panel-subtitle="Akun baru membuat checkout lebih cepat, klaim warranty lebih rapi, dan histori resep mudah ditemukan lagi."
  >
